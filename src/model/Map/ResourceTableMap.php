...
/**
 * This class defines the structure of the '_resource' table.
 *
 *
 *
...
class ResourceTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.ResourceTableMap';
     ...
     */
    const TABLE_NAME = '_resource';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\App\\Model\\Resource';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Resource';
     ...
     */
    const COL_ID = '_resource.id';

    /**
     * the column name for the name field
     */
    const COL_NAME = '_resource.name';

    /**
     * the column name for the value field
     */
    const COL_VALUE = '_resource.value';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(ResourceTableMap::COL_ID, ResourceTableMap::COL_NAME, ResourceTableMap::COL_VALUE, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(ResourceTableMap::COL_ID => 0, ResourceTableMap::COL_NAME => 1, ResourceTableMap::COL_VALUE => 2, ),
    ...
    {
        // attributes
        $this->setName('_resource');
        $this->setPhpName('Resource');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\App\\Model\\Resource');
        $this->setPackage('');
        $this->setUseIdGenerator(true);
        $this->setPrimaryKeyMethodInfo('_resource_id_seq');
        // columns
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ResourceTableMap::COL_ID);
            $criteria->addSelectColumn(ResourceTableMap::COL_NAME);
            $criteria->addSelectColumn(ResourceTableMap::COL_VALUE);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Model\Resource) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(ResourceTableMap::DATABASE_NAME);
            $criteria->add(ResourceTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(ResourceTableMap::COL_ID) && $criteria->keyContainsValue(ResourceTableMap::COL_ID) ) {
