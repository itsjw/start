...
/**
 * This class defines the structure of the '_user_role' table.
 *
 *
 *
...
class UserRoleTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.UserRoleTableMap';
     ...
     */
    const TABLE_NAME = '_user_role';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\App\\Model\\UserRole';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'UserRole';
     ...
     */
    const COL_USER_ID = '_user_role.user_id';

    /**
     * the column name for the role_id field
     */
    const COL_ROLE_ID = '_user_role.role_id';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_CAMELNAME     => array('userId', 'roleId', ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_CAMELNAME     => array('userId' => 0, 'roleId' => 1, ),
    ...
    {
        // attributes
        $this->setName('_user_role');
        $this->setPhpName('UserRole');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\App\\Model\\UserRole');
        $this->setPackage('');
        $this->setUseIdGenerator(false);
        $this->setIsCrossRef(true);
        // columns
        $this->addForeignPrimaryKey('user_id', 'UserId', 'INTEGER' , '_user', 'id', true, null, null);
        $this->addForeignPrimaryKey('role_id', 'RoleId', 'INTEGER' , '_role', 'id', true, null, null);
    } // initialize()
  ...
  array (
     ...
     * and findPk*() calls.
     *
     * @param \App\Model\UserRole $obj A \App\Model\UserRole object.
     ...
     *
     * @param mixed $value A \App\Model\UserRole object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \App\Model\UserRole) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \App\Model\UserRole object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Model\UserRole) { // it's a model object
    ...
    /**
     * Deletes all rows from the _user_role table.
     *
     * @param ConnectionInterface $con the connection to use
