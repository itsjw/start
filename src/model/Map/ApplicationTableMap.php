...
/**
 * This class defines the structure of the '_application' table.
 *
 *
 *
...
class ApplicationTableMap extends TableMap
{
     ...
     */
    const TABLE_NAME = '_application';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\App\\Model\\Application';
     ...
     */
    const COL_ID = '_application.id';

    /**
     * the column name for the name field
     */
    const COL_NAME = '_application.name';

    /**
     * the column name for the token field
     */
    const COL_TOKEN = '_application.token';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Token', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'token', ),
        self::TYPE_COLNAME       => array(ApplicationTableMap::COL_ID, ApplicationTableMap::COL_NAME, ApplicationTableMap::COL_TOKEN, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'token', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Token' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'token' => 2, ),
        self::TYPE_COLNAME       => array(ApplicationTableMap::COL_ID => 0, ApplicationTableMap::COL_NAME => 1, ApplicationTableMap::COL_TOKEN => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'token' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    {
        // attributes
        $this->setName('_application');
        $this->setPhpName('Application');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\App\\Model\\Application');
        $this->setPackage('');
        $this->setUseIdGenerator(true);
        $this->setPrimaryKeyMethodInfo('_application_id_seq');
        // columns
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ApplicationTableMap::COL_TOKEN);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Model\Application) { // it's a model object
