...
abstract class Activity implements ActiveRecordInterface
{
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[ActivityTableMap::COL_TITLE] = true;
        }
    ...
    public function setData($v)
    {
        ...
        if ($this->data !== $v) {
            $this->data = $v;
            $this->modifiedColumns[ActivityTableMap::COL_DATA] = true;
        }
    ...
    public function setClosedAt($v)
    {
        ...
        if ($this->closed_at !== null || $dt !== null) {
            if ($this->closed_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->closed_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[ActivityTableMap::COL_CLOSED_AT] = true;
            }
        } // if either are not null
