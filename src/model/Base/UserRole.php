...
/**
 * Base class that represents a row from the '_user_role' table.
 *
 *
 *
...
abstract class UserRole implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Model\\Map\\UserRoleTableMap';
    ...
    /**
     * Initializes internal state of App\Model\Base\UserRole object.
     */
     ...
     * @return $this|\App\Model\UserRole The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Model\\UserRole'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO _user_role (%s) VALUES (%s)',
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Model\UserRole
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Model\UserRole The current object, for fluid interface
     */
    ...
    public function hashCode()
    {
        ...
        //relation _user_role_fk_5804d8 to table _user
        ...
        //relation _user_role_fk_e1c7d1 to table _role
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Model\UserRole (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Model\UserRole Clone of current object.
     * @throws PropelException
     */
