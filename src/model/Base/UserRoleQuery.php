...
/**
 * Base class that represents a query for the '_user_role' table.
 *
 *
 *
...
abstract class UserRoleQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\Model\Base\UserRoleQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'start', $modelName = '\\App\\Model\\UserRole', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT user_id, role_id FROM _user_role WHERE user_id = :p0 AND role_id = :p1';
        try {
