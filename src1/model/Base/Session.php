...
/**
 * Base class that represents a row from the '_session' table.
 *
 *
 *
...
abstract class Session implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Model\\Map\\SessionTableMap';
    ...
    /**
     * Initializes internal state of App\Model\Base\Session object.
     */
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO _session (%s) VALUES (%s)',
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Model\Session The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Model\Session (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Model\Session Clone of current object.
     * @throws PropelException
     */
